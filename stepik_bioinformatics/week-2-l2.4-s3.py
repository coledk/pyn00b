#C-состав является важной характеристикой геномных последовательностей
...
#от регистра вводимых символов). Например, в строке "acggtgttat" процентное
#содержание символов G и C равно 4 / 10 * 100 = 40.0 
#где 4 - это количество символов G и C,  а 10 - это длина строки.

genome = input()
print(float((genome.upper().count('C')+genome.upper().count('G'))/len(genome))*100)